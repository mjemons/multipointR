...
test_that("fitModelAcrossImages works as shared model with interactions", {
    mdl <- fitModelAcrossImages(
        ...
        marks = "cellType",
        formula =
        as.formula("Keratin_Tumour ~ distfun(CD8_T_cell)"),
        threshold = 10
    )
...
test_that("fitModelAcrossImages works to flatten lists of
list of factors into plain vectors and then can fit them", {
    mdl <- fitModelAcrossImages(
        spe = spe,
        imageId = "imageID",
        imageLs = list("1", "2", "3"),
