...
```{r, plotFullDataset, fig.height=60, fig.width=30, echo=FALSE}
...
For the single image case, we will analyse image $6$
...
#why so ever I can't suppress the warnings with message = FALSE, results = "hide" and warning = FALSE [MR: you have warnings=FALSE .. could it be that it should be warning = FALSE?]
